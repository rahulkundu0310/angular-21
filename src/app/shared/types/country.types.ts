interface ICountryCoordinate {
	lat: number;
	lng: number;
}

interface ICountryBounds {
	northeast: ICountryCoordinate;
	southwest: ICountryCoordinate;
}

interface ICountryGeo {
	latitude: number;
	longitude: number;
	max_latitude: number;
	min_latitude: number;
